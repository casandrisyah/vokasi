<x-app-layout title="{{$data->id ? 'Perbarui' : 'Tambah'}} Penelitian">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid transition-fade">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <form id="form_input" class="form" data-redirect-url="{{route('office.dosen.research.index')}}" action="{{$data->id ? route('office.dosen.research.update', $data->id) : route('office.dosen.research.store')}}" method="{{$data->id ? 'PATCH' : 'POST'}}">
                <div class="card mb-5">
                    <div class="card-body">
                        <div class="row mb-10">
                        ...
                        <div class="text-center pt-15">
                            <a href="{{route('office.dosen.research.index')}}" class="menu-link btn btn-light me-3">Batal</a>
