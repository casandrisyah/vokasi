<x-app-layout title="Riwayat Pendidikan">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ route('office.civitas.staff.education.create', $staff->id) }}" class="menu-link btn btn-primary">Tambah Riwayat Pendidikan</a>
                        </div>
                    </div>
                </div>
